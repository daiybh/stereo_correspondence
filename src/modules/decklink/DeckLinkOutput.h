...
protected:
	...
	bool step();
	inline std::shared_ptr<DeckLink3DVideoFrame> get_active_buffer();
	inline std::shared_ptr<DeckLink3DVideoFrame> get_next_buffer();
	inline std::shared_ptr<DeckLink3DVideoFrame> do_get_active_buffer();
	inline std::shared_ptr<DeckLink3DVideoFrame> do_get_next_buffer();
...
protected:
	...
	bool fill_frame(core::pRawVideoFrame source, std::shared_ptr<DeckLink3DVideoFrame> output);
protected:
	...
	std::deque<std::shared_ptr<DeckLink3DVideoFrame> > out_frames;
