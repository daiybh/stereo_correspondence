...
public:
	...
	static bool 				configure_converter(Parameters&, yuri::format_t ,
				yuri::format_t);
								...
								BasicIOThread(Log &log_, pThreadBase parent,
...
//	static pBasicFrame allocate_frame_from_memory(shared_array<yuri::ubyte_t> mem, yuri::size_t size, bool large=false);
	...
	static bool 				connect_threads(shared_ptr<BasicIOThread>,
			yuri::sint_t, shared_ptr<BasicIOThread>, yuri::sint_t, Log &log,
			std::string name, shared_ptr<Parameters> params = shared_ptr<Parameters>());
